# borrowed from https://github.com/Huage001/LinFusion/blob/main/src/linfusion/linfusion.py

from diffusers.models.attention_processor import Attention
from diffusers import ModelMixin, ConfigMixin
import functools

from .linfusion_attention import GeneralizedLinearAttention
...
class LinFusion(ModelMixin, ConfigMixin):
    ...
    def construct_for(
        ...
        if load_pretrained:
            ...
            pipe_name_path = 'runwayml/stable-diffusion-v1-5'
