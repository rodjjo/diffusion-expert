...
from dfe.images.proc_lineart import LineartDetector
from dfe.images.manga_line import MangaLineExtration
...
def pre_process_image(data: dict, params: dict) -> dict:
    progress(1, 3)
