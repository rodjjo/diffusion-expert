...
from dfe.misc.config import PREPROC_DIR
from dfe.misc.downloader import download_file
...
class MangaLineExtration:
    model_dir = os.path.join(PREPROC_DIR, "manga_line")
    ...
    def load_model(self):
        ...
        download_file(remote_model_path, self.model_dir, "erika.pth")
